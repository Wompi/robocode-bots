...
public class NatSim
{
	 ...
	 */
	private static double getVelocity(double currentVelocity, double maxVelocity, double distanceRemaining)
	{
		if (distanceRemaining < 0) { return -getVelocity(-currentVelocity, maxVelocity, -distanceRemaining); }
