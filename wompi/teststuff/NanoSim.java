...
/**
 * My attempt to make a very very small modern precise predictor Codesize: 168
 * bytes
 * 
 * @author Chase
 */
public class NanoSim {
	public static void main(String[] args) {
		...
		for (int i = 0; i < ticks; i++) {
			...
			System.out.format(
					"[%d] %11.4f %11.4f %11.4f %11.4f maxTurn=%10.4f\n", i,
					WompiSim.x, WompiSim.y, WompiSim.h, WompiSim.v,
					Rules.getTurnRateRadians(WompiSim.v));
		}
